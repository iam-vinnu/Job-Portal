      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row justify-between items-center">
          <div className="mb-4 md:mb-0">
            ...
            <p className="text-sm">© 2024 YouHired. All rights reserved.</p>
          </div>
          
          <div className="flex space-x-4 mt-4 md:mt-0">
            <a href="https://facebook.com" className="text-[#2e52e6] hover:text-gray-400" aria-label="Facebook">
            ...
            <a href="https://twitter.com" className="text-[#2e52e6] hover:text-gray-400" aria-label="Twitter">
            ...
            <a href="https://linkedin.com" className="text-[#2e52e6] hover:text-gray-400" aria-label="LinkedIn">
